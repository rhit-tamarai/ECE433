...
#
# Generated by export_simulation on Mon Nov 04 12:38:22 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './Clock25MHz.sh' script.

./Clock25MHz.sh -reset_run
...
./Clock25MHz.sh -noclean_files

For more information on the script, please type './Clock25MHz.sh -help'.
